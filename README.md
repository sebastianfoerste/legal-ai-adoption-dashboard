...
CI: passing. Deterministic tests cover health scoring, Adoption Cockpit analytics and synthetic data contracts.
...
The Adoption Cockpit adds a local synthetic review summary: which product areas are
used, which evidence files support the deck, which actions remain blocked, and
...
This is the legal-AI platform adoption path:
...
6. **Adoption profile:** inspect the Adoption Cockpit coverage table before turning any synthetic insight into a leadership deck or account action.
...
5. **Adoption Insights** (`/insights`): constrained adoption analytics, review-gated capability recommendations and a filterable leadership report package.
